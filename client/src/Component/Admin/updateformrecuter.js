...
function UpdateFormRecuter  (props)  {
  ...
  return (
    ...
    <div class="w-1/2 bg-white rounded shadow-2xl p-8 m-4">
        ...
        <form  onSubmit={handleClick}>
            ...
            <div class="flex flex-col mb-4">
                <label class="mb-2 font-bold text-lg text-gray-900" for="email">Companyname</label>
                <input value={props.companyname} onChange={handleChange} class="border py-2 px-3 text-grey-800" type="text" name="companyname" id="companyname"/>
            </div>
            <div class="flex flex-col mb-4">
                <label class="mb-2 font-bold text-lg text-gray-900" for="email">Like</label>
                <input value={props.like} onChange={handleChange} class="border py-2 px-3 text-grey-800" type="number" name="like" id="like"/>
            </div>
            <div class="flex flex-col mb-4">
                <label class="mb-2 font-bold text-lg text-gray-900" for="email">Dislike</label>
                <input value={props.dislike} onChange={handleChange} class="border py-2 px-3 text-grey-800" type="number" name="dislike" id="dislike"/>
            </div>
...
export default UpdateFormRecuter